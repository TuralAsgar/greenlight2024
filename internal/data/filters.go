...
// In the offset() method there is
// the theoretical risk of an integer
// overflow as we are multiplying
// two int values together. However,
// this is mitigated by the validation
// rules we created in our ValidateFilters()
// function, where we enforced maximum values
// of page_size=100 and page=10000000 (10 million).
// This means that the value returned by offset()
// should never come close to overflowing.
